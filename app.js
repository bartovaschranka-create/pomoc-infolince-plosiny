(() => {
  ...
  function iconTrailerOmme() {
    return `<svg viewBox="0 0 120 90" class="icon-drawing purple" role="img"><path d="M13 72h72M26 72h36M43 72a7 7 0 1 0 .1 0M16 66l15-7 23-30 25 10M55 29l30-8 14 7M96 22h16v18H96zM86 72l14-8"/></svg>`;
  }
  function iconMast() {
    return `<svg viewBox="0 0 120 90" class="icon-drawing cyan" role="img"><path d="M42 74h34M48 74a5 5 0 1 0 .1 0M70 74a5 5 0 1 0 .1 0M58 72V22M48 22h20M48 34h20M48 46h20M68 30h25v18H68"/></svg>`;
  }
  ...
  function runSearch() {
    ...
    const categoryMachines = machines.filter((machine) => machine.category === selectedCategory);
  ...
  function evaluateMachine(machine, filters) {
    ...
    compareMinimum(machine.capacityKg, filters.capacity, "nosnost", "kg", 5);
  ...
  function renderMachineCard(item, filters, nearestOnly, index, wholeCatalog = false) {
    ...
    const category = categoryMap[machine.category];
        ...
        <div class="machine-content">
          <div class="machine-head">
            <div>
              ...
              <p class="machine-category">${escapeHtml(category.label)} plošina · ${escapeHtml(machine.sourceCategory || "")}</p>
            </div>
            <div class="price-box">
